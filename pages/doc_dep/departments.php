                ...
                <div class="display-card-top-bottom card">
                    ...
                    <div class="display-card-top">
                        ...
                        <div class="btns">
                            ...
                            <button
                                class="btn btn-info"
                                onclick="window.location.href='add_dep.php?id=DEP001'">
                ...
                <div class="display-card-top-bottom card">
                    ...
                    <div class="display-card-top">
                        ...
                        <div class="btns">
                            ...
                            <button
                                class="btn btn-info"
                                onclick="window.location.href='add_dep.php?id=DEP002'">
                ...
                <div class="display-card-top-bottom card">
                    ...
                    <div class="display-card-top">
                        ...
                        <div class="btns">
                            ...
                            <button
                                class="btn btn-info"
                                onclick="window.location.href='add_dep.php?id=DEP003'">
