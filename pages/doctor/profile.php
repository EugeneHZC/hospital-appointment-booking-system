        ...
        <div id="view-section">
          <div class="card">
            <div class="profile-header">
              ...
              <div>
                <h2 id="profile-name">Doctor Name</h2>
                <span class="profile-badge" id="profile-specialization">Specialist</span>
              </div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="info-value" id="display-office">West Wing Second Floor</div>
            </div>
            <div class="info-row">
              <div class="info-label">
                <i class="fa-regular fa-calendar"></i> Schedule
              </div>
              <div class="info-value" id="display-schedule">—</div>
            </div>
            <div class="info-row">
              <div class="info-label">
